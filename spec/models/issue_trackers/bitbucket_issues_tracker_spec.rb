...
EOF
    ...
    stub_request(:post, "https://bitbucket.org/api/1.0/repositories/test_user/test_repo/issues/").
      with( headers: { 'Accept'=>'*/*' } ).
    ...
    expect(WebMock).to have_requested(:post, "https://bitbucket.org/api/1.0/repositories/test_user/test_repo/issues/")
